...
<form method="post" id="configform" action="setup-config.php?step=2">
	...
	<table class="form-table">
		<tr>
			...
			<td><input name="dbname" id="dbname" type="text" size="25" value="vetclinicdocmgmt" class="required" minlength="2" READONLY /></td>
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" size="25" value="localhost" class="required" minlength="2" READONLY /></td>
		...
		<tr>
			...
			<td><input name="prefix" id="prefix" type="text" value="odm_" size="8" class="required" minlength="2" READONLY /></td>
		</tr>
                <tr>
		...
		<tr>
			...
			<td colspan="2"><input name="datadir" id="datadir" type="text" value="<?php echo dirname($_SERVER['DOCUMENT_ROOT']);?>/www/vetclinic/docmgmt/data/" size="45" class="required" minlength="2"/ READONLY>
                        </td>
		</tr>
                <tr>
			<th scope="row"><label for="prefix">Base URL</label></th>
			<td colspan="2"><input name="baseurl" id="baseurl" type="text" size="45" class="required url2" minlength="2" value="http://<?php echo $_SERVER['HTTP_HOST'];?>/wamp/www/vetclinic/docmgmt/" READONLY />
                        </td>
		</tr>
	</table>
...
<p class="step"><a href="/vetclinic/install/install5.php" class="button">Run the install</a></p>
<?php
